...
const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    description: 'Pick up to 3 trackers — Personal, Group, or Reimbursement. Each one gets its own button right in the notification, so you can route expenses with a single tap.',
    highlight: 'Home screen (top section)',
  },
  {
    emoji: '⏸️',
    title: 'Pause Tracking Anytime',
    description: 'Use the toggle switch next to "Active Trackers" to pause all tracking without losing your slot selections. Turn it back on and everything resumes instantly.',
