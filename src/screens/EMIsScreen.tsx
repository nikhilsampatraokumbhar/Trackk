...
import { scanHistoricalSMS, scanFromStoredTransactions, checkEMICompletions } from '../services/AutoDetectionService';
...
const styles = StyleSheet.create({
  ...
  backIcon: { fontSize: 28, color: COLORS.warning, fontWeight: '300', marginRight: 2, marginTop: -2 },
  backText: { fontSize: 14, color: COLORS.warning, fontWeight: '600' },
  ...
  syncBtn: { width: 36, height: 36, borderRadius: 18, backgroundColor: `${COLORS.warning}20`, alignItems: 'center', justifyContent: 'center' },
  syncIcon: { fontSize: 20, color: COLORS.warning, fontWeight: '700' },
